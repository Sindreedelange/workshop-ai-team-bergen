...
set SERVICES=sandbox-backend fiks-simulator ai-gateway pdf-extractor tools-api process-agent matrikkel-mock digdir-mock pasientjournal-mock politiattest-mock plan-mock demo-gui process-builder
set SERVICE_PORTS=3000 3001 8080 8081 8082 8083 8084 8085 8086 8087 8088 8089 8090
