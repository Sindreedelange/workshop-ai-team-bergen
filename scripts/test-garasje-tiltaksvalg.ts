...
import { validateByggetiltak } from "../apps/sandbox-backend/src/garasje.ts";
import { normalizeGarasjeSvar } from "../apps/sandbox-backend/src/garasje-prosess.ts";
...
assert.doesNotThrow(() => normalizeGarasjeSvar({
