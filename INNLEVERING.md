...
- **De store datafilene er på vei ut, og noen er ute.**
  [`docs/innlevering.md`](docs/innlevering.md) ber om at datasett på flere megabyte ikke
  commites, og vi hadde omtrent 150 MB av dem. Adressegrunnlaget (12,6 MB) og Bergens
  teiguttrekk (96,6 MB) er nå borte: begge hentes fra Geonorge og Kartverket ved oppslag.
  Igjen står KPA2018-lagene som GeoJSON og de seks referanse-PDF-ene.
  Grunnen til at de lå der var at kartsteget og dokumentsøket skulle virke uten nett. Den
  grunnen holdt dårligere enn den så ut: adressesøket har aldri hatt en lokal kopi, så
  uten nett stoppet tiltakssjekken på steg én uansett. Hvor hvert datasett kommer fra nå,
  står i [`docs/datakilder.md`](docs/datakilder.md).
