...
export const OPPGAVE_REASONING: Record<string, { tenker: boolean; grunn: string }> = {
  ...
  "strukturer-dokument": { tenker: false, grunn: "Strukturerer dokumenttekst med kildebevis, uten selvstendige slutninger." },
  "strukturer-dokument-fallback": { tenker: false, grunn: "Reserve for dokumentstrukturering med samme krav til kildebevis." },
  "les-dokumentside": { tenker: false, grunn: "Leser synlig innhold i en dokumentside, ikke en juridisk vurdering." }
};
