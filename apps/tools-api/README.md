...
Garasjerådet bruker `pdf_list_documents` for kildemetadata og `pdf_search_chunks`
...
PDF-oppslag har fem sekunders tidsgrense. Et søketreff er ikke en bekreftet
byggetillatelse; kildehenvisninger og kvalitetsvarsler skal følge svaret.
