  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        kontekst: {
          type: "object",
          description: "Grounding from the active process and previously fetched results. Relevant public reference data is added automatically when needed.",
          properties: {
