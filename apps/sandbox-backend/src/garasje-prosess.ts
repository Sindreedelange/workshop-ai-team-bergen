...
import { validateByggetiltak, validateGarasjeTiltak } from "./garasje.ts";
...
export function buildGarasjeTiltak(svar: Record<string, string | number>): GarasjeTiltak | Byggetiltak {
